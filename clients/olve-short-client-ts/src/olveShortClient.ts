...
// @ts-ignore
import { EchoRequestBuilderRequestsMetadata, type EchoRequestBuilder } from './echo/index.js';
// @ts-ignore
...
/**
 * Instantiates a new {@link OlveShortClient} and sets the default values.
 * @param requestAdapter The request adapter to use to execute the requests.
 */
// @ts-ignore
export function createOlveShortClient(requestAdapter: RequestAdapter) {
    ...
    return apiClientProxifier<OlveShortClient>(requestAdapter, pathParameters, OlveShortClientNavigationMetadata, undefined);
}
/**
 * The main entry point of the SDK, exposes the configuration and the fluent API.
 */
export interface OlveShortClient extends BaseRequestBuilder<OlveShortClient> {
    /**
     * The echo property
     */
    get echo(): EchoRequestBuilder;
    /**
     * The health property
     */
 ...
 */
export const OlveShortClientUriTemplate = "{+baseurl}";
/**
 * Metadata for all the navigation properties in the request builder.
 */
export const OlveShortClientNavigationMetadata: Record<Exclude<keyof OlveShortClient, KeysToExcludeForNavigationMetadata>, NavigationMetadata> = {
    echo: {
        requestsMetadata: EchoRequestBuilderRequestsMetadata,
    },
    health: {
